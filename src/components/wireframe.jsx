...
function WfCassette({
  ...
  return (
    ...
    >
      ...
      <g
        style={{
          transformOrigin: "55px 78px",
          animation: "wfRotate 4s linear infinite",
        }}
      >
        <circle
          cx="55"
...
function WfHeadstock({
  ...
  return (
    ...
    >
      {/* neck stub */}
      <path
        d="M 30 130 L 50 130 L 50 110 L 30 110 Z"
        fill="none"
        stroke={color}
        strokeWidth="1"
      />
    ...
    >
      ...
      {Array.from({ length: stringCount }).map((_, i) => (
        <line
          key={i}
          x1="0"
          y1={(i + 0.5) * (height / stringCount)}
          x2={width}
          y2={(i + 0.5) * (height / stringCount)}
          stroke={color}
...
function ChordDiagram({
  ...
  const minFret = playedFrets.length
  ...
  return (
    ...
    >
      ...
      {/* fret lines */}
      {Array.from({ length: visibleFrets + 1 }).map(
        (_, i) => (
          <line
            key={`f${i}`}
            x1={padX}
      ...
      {frets.map((f, i) => {
        ...
        if (offset < 1 || offset > visibleFrets)
          return null;
        const x = padX + i * stringSpacing;
